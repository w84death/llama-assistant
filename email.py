# Frontend for the eMailWriter - your shadow writer for formal emails and Slack messages
# Version 1.0
...
class ChatApp:
    def __init__(self, master):
        ...
        self.master.title('eMailWriter // Steam Deck Version')
        ...
        self.process = Popen(["stdbuf", "-o0", "./email-steamdeck.sh"], stdin=PIPE, stdout=PIPE, stderr=PIPE, bufsize=1)
